...
public class DBHelper extends SQLiteOpenHelper {
    ...
    static final String LOGIN_KEY_USERNAME = "username";
    static final String LOGIN_KEY_PASSWORD = "password";
    static final String LOGIN_KEY_FINGERPRINT = "enrolled_biometric";
